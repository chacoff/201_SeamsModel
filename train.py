...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/Seams5s.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='dataset/Seams/seams.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='exp14_weighted', help='save to project/name')
