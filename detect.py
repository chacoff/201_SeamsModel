...
def detect(save_img=False):
    source, weights, view_img, save_txt, imgsz, imgdisp = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, opt.img_display
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if view_img:
                ...
                cv2.imshow(str(p), cv2.resize(im0, None, fx=imgdisp, fy=imgdisp))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='exp11', help='save results to project/name')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    parser.add_argument('--img-display', type=float, default=0.35)
